...
class ForexIterator(private val candles: List<Candle>,
                    ...
                    private val tradeDetails: List<TradeDetails>) : DataSetIterator {
    ...
    override fun next(): DataSet {
        ...
        val featureMask = Nd4j.create(intArrayOf(batchSize, tradingCandles), 'f')
        val labelsMask = Nd4j.create(intArrayOf(batchSize, tradingCandles), 'f')
        ...
        for (batch in 0 until batchSize) {
            ...
            for ((i, candle) in relevantCandles.withIndex()) {
                ...
                featureMask.putScalar(batch, i, 1.0)
            }
            labelsMask.putScalar(batch,  relevantCandles.size - 1, 1.0)
            cursor++
        }
